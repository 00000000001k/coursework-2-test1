    ...
    public partial class Form1 : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                // 
                this.dataGridView1.Columns["Display"].Visible = false;
        ...
        private void dataGridView1_CellMouseDown(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                try
                {
                    ...
                    var selectedBiodataId = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[1].Value);
                }
                catch (Exception)
                {
        ...
        public void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            label1.Text = dataGridView1.Rows[rowIndex].Cells[1].Value.ToString();
            label2.Text = dataGridView1.Rows[rowIndex].Cells[3].Value.ToString();
        }
